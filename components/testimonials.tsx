...
/* 
  以下内容基于此前已下架的插件场景进行文案重构。
  场景说明：
  - 我们的上一款插件即将被下架，希望用户趁下架前免费安装使用（无需付费）。后续可能会收费，但现在仍能免费体验。
  - 强调抓住最后机会安装（比如在下架前、或付费模式生效前）。
  - 调性：真实用户对即将失去的神器般插件的依依不舍和强烈推荐，让新用户及时安装。

  注意：公司名换成美国大厂，以突出专业与权威。
*/
...
const testimonials = [
	{
		...
		company: 'Google',
		content:
			"I've relied on this plugin daily for instant coding solutions. Now it's on the brink of disappearing. If you haven't installed it yet, do it while it's still free—it's been a total game-changer!",
		categories: [1, 3, 5]
	},
	{
		...
		company: 'Amazon',
		content:
			"This extension saved me countless hours. Hearing it'll be gone soon is unreal. If you value your time, install it now before it vanishes—trust me, you won't regret it.",
		categories: [1, 2, 4]
	},
	{
		...
		company: 'Microsoft',
		content:
			"It felt like having a personal coding guru 24/7. I can't believe we're losing it. Hurry and grab it now—this is the final call for a truly must-have tool.",
		categories: [1, 2, 5]
	},
	{
		...
		company: 'Apple',
		content:
			"I was skeptical at first, but it transformed my coding process. Knowing it's going away is such a blow. Install now while you can—no subscription required yet!",
		categories: [1, 4]
	},
	{
		...
		company: 'Meta',
		content:
			"No setup hassle, instant solutions. I still can't believe we'll lose this magic tool. If you're reading this, grab the plugin while it's free and available.",
		categories: [1, 3, 5]
	},
	{
		...
		company: 'Netflix',
		content:
			"No more guesswork—just quick, accurate answers. It's a punch in the gut that it's ending. Don't miss out—install before it's too late.",
		categories: [1, 3]
	},
	{
		...
		company: 'Tesla',
		content:
			"This extension took me from hours of struggle to minutes of clarity. Now it's slipping away. If you ever wanted an edge, now's the time—install it free before the curtain falls.",
		categories: [1, 2, 5]
	},
	{
		...
		company: 'Nvidia',
		content:
			"I depended on its instant hints daily. It's crushing to know it'll vanish. Install it now—finding another tool this effective without paying later will be tough.",
		categories: [1, 4]
	},
	{
		...
		company: 'IBM',
		content:
			"I can't imagine coding without it. To anyone who hasn't tried it: this is your last shot. Install now, completely free, and you'll be thankful you did.",
		categories: [1, 2]
	}
]
			...
			<div className='border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20'>
				...
				<div className='mx-auto max-w-3xl pb-12 text-center'>
					...
					<p className='text-lg text-indigo-200/65'>
						These users got the best of it before it's gone. Install now, enjoy
						free access, and see why they're urging you not to wait.
					</p>
				</div>

				<div>
					{/* Buttons (Categories remain but their meaning is less relevant now) */}
